...
class PolygonMasks:
    ...
    def __init__(self, polygons: List[List[Union[torch.Tensor, np.ndarray]]]):
        ...
        def process_polygons(
            ...
            polygons_per_instance = [_make_array(
                p) for p in polygons_per_instance]
        ...
        for idx, polygons_per_instance in enumerate(self.polygons):
            ...
            for polygon in polygons_per_instance:
                coords = torch.from_numpy(
                    polygon).view(-1, 2).to(dtype=torch.float32)
    ...
    def cat(polymasks_list: List["PolygonMasks"]) -> "PolygonMasks":
        ...
        assert all(isinstance(polymask, PolygonMasks)
                   for polymask in polymasks_list)
...
class ROIMasks:
    ...
    def to_bitmasks(self, boxes: torch.Tensor, height, width, threshold=0.5):
        ...
        bitmasks = paste_func(self.tensor, boxes.tensor,
