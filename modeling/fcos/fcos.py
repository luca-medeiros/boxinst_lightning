...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 14 14:13:14 2021
...
from layers import compute_locations, ShapeSpec
from modeling.fcos.fcos_outputs import FCOSOutputs
...
class FCOS(nn.Module):
    ...
    def __init__(self, cfg, input_shape: Dict[str, ShapeSpec]):
        super().__init__()
        self.in_features = cfg.model.rpn.fcos.in_features
        self.fpn_strides = cfg.model.rpn.fcos.fpn_strides
        self.yield_proposal = cfg.model.rpn.fcos.yield_proposal

        self.fcos_head = FCOSHead(cfg, [input_shape[i] for i, f in enumerate(self.in_features)])
...
class FCOSHead(nn.Module):
    def __init__(self, cfg, input_shape: List[ShapeSpec]):
        ...
        self.fpn_strides = cfg.model.rpn.fcos.fpn_strides
        head_configs = {"cls": (cfg.model.rpn.fcos.num_cls_convs,
                                cfg.model.rpn.fcos.use_deformable),
                        "bbox": (cfg.model.rpn.fcos.num_box_convs,
                                 cfg.model.rpn.fcos.use_deformable),
                        "share": (cfg.model.rpn.fcos.num_share_convs,
                                  False)}
        norm = None if cfg.model.rpn.fcos.norm == "none" else cfg.model.rpn.fcos.norm
        ...
        if cfg.model.rpn.fcos.use_scale:
